...
class BasketTwoStageDetector:
    ...
    def print_param(self):
        ...
        print(f"- min_area_green_ratio: {self.min_area_green_ratio:.8f}")
        print(f"- min_area_red_ratio  : {self.min_area_red_ratio:.8f}")
...
if __name__ == "__main__":
    ...
    # 1280x720 기준: green 5000px, red 500px에 맞춘 기본값
    ...
    src = sys.argv[1] if len(sys.argv) > 1 else "video_path.mp4"
    ...
    while True:
        ...
        if mode == 'GREEN':
            color = (0, 220, 0)
            cv2.putText(frame, "[MODE] GREEN", (10, 20),
