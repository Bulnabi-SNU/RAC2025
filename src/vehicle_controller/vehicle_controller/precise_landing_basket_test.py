...
class MissionState(Enum):
    ...
    # 위에 skip! 그냥 바로 상공 35m로 이동
    MOVE_TO_TARGET = "MOVE_TO_TARGET"
    LANDING_TAG_DESCEND_15M = "LANDING_TAG_DESCEND_15M"
...
class MissionController(PX4BaseController):
    ...
    def main_loop(self):
        ...
        state_handlers = {
            ...
            MissionState.LANDING_TAG_FINAL_DESCEND: lambda: self._handle_descend_ascend(MissionState.LANDING_TAG_FINAL_HOVER, 0.3),
    ...
    def _handle_offboard_arm(self):
        ...
        if self.is_disarmed():
            ...
            # self._start_logging()
            self.state = MissionState.MOVE_TO_TARGET
